...
def loadFont(scriptPath : str):
    global font
    global font2
    font_size = 24
    normalizedPath = scriptPath.replace("\\", "/")
    normalizedPath = normalizedPath[0:normalizedPath.rindex('/')]
    font = ImageFont.truetype(normalizedPath + '/human_taegothic.ttf', font_size)
    font2 = ImageFont.truetype(normalizedPath + '/human_taegothic.ttf', 12)
